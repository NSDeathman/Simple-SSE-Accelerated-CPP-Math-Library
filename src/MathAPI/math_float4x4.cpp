...
namespace Math
{
     ...
     */
    float4x4::float4x4(const float4& col0, const float4& col1, const float4& col2, const float4& col3) noexcept
     ...
     */
    float4x4::float4x4(const float* data) noexcept
     ...
     */
    float4x4::float4x4(float scalar) noexcept
        : col0_(scalar, 0, 0, 0)
        , col1_(0, scalar, 0, 0)
        , col2_(0, 0, scalar, 0)
        , col3_(0, 0, 0, scalar) {}
     ...
     */
    float4x4::float4x4(const float4& diagonal) noexcept
     ...
     */
    float4x4::float4x4(const float3x3& mat3x3) noexcept
    {
     ...
     */
    float4x4::float4x4(const quaternion& q) noexcept
    {
     ...
     */
    float4x4::float4x4(const D3DXMATRIX& mat) noexcept
     ...
     * @note Converts from DirectX row-major to internal column-major storage
     */
    float4x4& float4x4::operator=(const D3DXMATRIX& mat) noexcept
    {
     ...
     */
    float4x4 float4x4::identity() noexcept
    {
        return float4x4(
            float4(1, 0, 0, 0),
            float4(0, 1, 0, 0),
     ...
     */
    float4x4 float4x4::zero() noexcept
    {
        return float4x4(
            float4(0, 0, 0, 0),
            float4(0, 0, 0, 0),
     ...
     */
    float4x4 float4x4::translation(const float3& translation) noexcept
    {
        return float4x4(
     ...
     * @return Translation matrix
     */
    float4x4 float4x4::translation(float x, float y, float z) noexcept
    {
     ...
     */
    float4x4 float4x4::scaling(const float3& scale) noexcept
    {
        return float4x4(
     ...
     * @return Scaling matrix
     */
    float4x4 float4x4::scaling(float x, float y, float z) noexcept
    {
     ...
     * @return Scaling matrix
     */
    float4x4 float4x4::scaling(float uniformScale) noexcept
    {
     ...
     */
    float4x4 float4x4::rotation_x(float angle) noexcept
    {
        float s, c;
     ...
     */
    float4x4 float4x4::rotation_y(float angle) noexcept
    {
        float s, c;
        MathFunctions::sin_cos(angle, &s, &c);
     ...
     */
    float4x4 float4x4::rotation_z(float angle) noexcept
    {
        float s, c;
        MathFunctions::sin_cos(angle, &s, &c);
     ...
     */
    float4x4 float4x4::rotation_axis(const float3& axis, float angle) noexcept
    {
        float s, c;
        MathFunctions::sin_cos(angle, &s, &c);
     ...
     */
    float4x4 float4x4::rotation_euler(const float3& angles) noexcept
    {
     ...
     */
    float4x4 float4x4::orthographic(float left, float right, float bottom, float top, float zNear, float zFar) noexcept
    {
     ...
     */
    float4x4 float4x4::perspective(float fovY, float aspect, float zNear, float zFar) noexcept
    {
     ...
     */
    float4x4 float4x4::look_at(const float3& eye, const float3& target, const float3& up) noexcept
    {
     ...
     */
    float4x4 float4x4::TRS(const float3& _translation, const quaternion& rotation, const float3& scale) noexcept
    {
     ...
     */
    float4& float4x4::operator[](int colIndex) noexcept
    {
     ...
     */
    const float4& float4x4::operator[](int colIndex) const noexcept
    {
        return (colIndex == 0) ? col0_ : (colIndex == 1) ? col1_ : (colIndex == 2) ? col2_ : col3_;
    }
     ...
     */
    float& float4x4::operator()(int row, int col) noexcept
    {
     ...
     */
    const float& float4x4::operator()(int row, int col) const noexcept
    {
        return (*this)[col][row]; // column-major: [col][row]
    }
     ...
     * @return First column
     */
    float4 float4x4::col0() const noexcept { return col0_; }

    /**
     * @brief Get column 1
     * @return Second column
     */
    float4 float4x4::col1() const noexcept { return col1_; }

    /**
     * @brief Get column 2
     * @return Third column
     */
    float4 float4x4::col2() const noexcept { return col2_; }

    /**
     * @brief Get column 3
     * @return Fourth column (translation/perspective)
     */
    float4 float4x4::col3() const noexcept { return col3_; }

    float4 float4x4::row0() const noexcept 
    {
        return float4(col0_.x, col1_.x, col2_.x, col3_.x);
    }

    float4 float4x4::row1() const noexcept 
    {
        return float4(col0_.y, col1_.y, col2_.y, col3_.y);
    }

    float4 float4x4::row2() const noexcept 
    {
        return float4(col0_.z, col1_.z, col2_.z, col3_.z);
    }

    float4 float4x4::row3() const noexcept 
    {
     ...
     */
    void float4x4::set_col0(const float4& col) noexcept { col0_ = col; }

    /**
     * @brief Set column 1
     * @param col New column values
     */
    void float4x4::set_col1(const float4& col) noexcept { col1_ = col; }

    /**
     * @brief Set column 2
     * @param col New column values
     */
    void float4x4::set_col2(const float4& col) noexcept { col2_ = col; }

    /**
     * @brief Set column 3
     * @param col New column values
     */
    void float4x4::set_col3(const float4& col) noexcept { col3_ = col; }

    /**
     * @brief Set row 0
     * @param row New row values
     */
    void float4x4::set_row0(const float4& row) noexcept
    {
        col0_.x = row.x;
        col1_.x = row.y;
        col2_.x = row.z;
     ...
     * @param row New row values
     */
    void float4x4::set_row1(const float4& row) noexcept
    {
        col0_.y = row.x;
        col1_.y = row.y;
        col2_.y = row.z;
     ...
     * @param row New row values
     */
    void float4x4::set_row2(const float4& row) noexcept
    {
        col0_.z = row.x;
        col1_.z = row.y;
        col2_.z = row.z;
     ...
     * @param row New row values
     */
    void float4x4::set_row3(const float4& row) noexcept
    {
        col0_.w = row.x;
        col1_.w = row.y;
        col2_.w = row.z;
     ...
     */
    float4x4 float4x4::operator+() const noexcept { return *this; }
    ...
    float4x4 float4x4::inverted_affine() const noexcept
    {
     ...
     */
    float4x4 float4x4::inverted() const noexcept
    {
     ...
     */
    float3x3 float4x4::normal_matrix() const noexcept
    {
     ...
     * @return Trace value
     */
    float float4x4::trace() const noexcept
    {
     ...
     */
    float4 float4x4::diagonal() const noexcept
    {
     ...
     */
    float float4x4::frobenius_norm() const noexcept
    {
     ...
     */
    float4 float4x4::transform_vector(const float4& vec) const noexcept
    {
     ...
     */
    float3 float4x4::transform_point(const float3& point) const noexcept
    {
     ...
     */
    float3 float4x4::transform_vector(const float3& vec) const noexcept
    {
     ...
     */
    float3 float4x4::transform_direction(const float3& dir) const noexcept
    {
     ...
     */
    float3 float4x4::get_translation() const noexcept
    {
     ...
     */
    float3 float4x4::get_scale() const noexcept
    {
        return float3(
     ...
     */
    quaternion float4x4::get_rotation() const noexcept
    {
     ...
     */
    void float4x4::set_translation(const float3& translation) noexcept
    {
     ...
     */
    void float4x4::set_scale(const float3& scale) noexcept
    {
     ...
     */
    bool float4x4::is_identity(float epsilon) const noexcept
    {
     ...
     */
    bool float4x4::is_affine(float epsilon) const noexcept
    {
     ...
     */
    bool float4x4::is_orthogonal(float epsilon) const noexcept
    {
     ...
     */
    bool float4x4::approximately(const float4x4& other, float epsilon) const noexcept
    {
     ...
     */
    void float4x4::to_column_major(float* data) const noexcept
    {
     ...
     */
    void float4x4::to_row_major(float* data) const noexcept
    {
     ...
     */
    float4x4::operator D3DXMATRIX() const noexcept
    {
        D3DXMATRIX result;
     ...
     * @return True if matrices are approximately equal
     */
    bool float4x4::operator==(const float4x4& rhs) const noexcept
    {
     ...
     */
    const float4x4 float4x4_Identity = float4x4::identity();

    /**
     * @brief Zero matrix constant
     */
    const float4x4 float4x4_Zero = float4x4::zero();
} // namespace Math
