...
namespace Math
{
     ...
     */
    inline float2x2 operator+(float2x2 lhs, const float2x2& rhs) noexcept { return lhs += rhs; }
     ...
     */
    inline float2x2 operator*(float2x2 mat, float scalar) noexcept { return mat *= scalar; }
     ...
     * @return Scaled matrix
     */
    inline float2x2 operator*(float scalar, float2x2 mat) noexcept { return mat *= scalar; }
     ...
     * @return Transposed matrix
     */
    inline float2x2 transpose(const float2x2& mat) noexcept { return mat.transposed(); }
     ...
     * @return Inverse matrix
     */
    inline float2x2 inverse(const float2x2& mat) noexcept { return mat.inverted(); }
     ...
     * @return Determinant value
     */
    inline float determinant(const float2x2& mat) noexcept { return mat.determinant(); }
     ...
     * @return Transformed vector
     */
    inline float2 mul(const float2& vec, const float2x2& mat) noexcept { return vec * mat; }
     ...
     * @return Product matrix
     */
    inline float2x2 mul(const float2x2& lhs, const float2x2& rhs) noexcept { return lhs * rhs; }
     ...
     * @return Trace value
     */
    inline float trace(const float2x2& mat) noexcept { return mat.trace(); }
     ...
     */
    inline float2 diagonal(const float2x2& mat) noexcept { return mat.diagonal(); }
     ...
     * @return Frobenius norm
     */
    inline float frobenius_norm(const float2x2& mat) noexcept { return mat.frobenius_norm(); }
     ...
     * @return True if matrices are approximately equal
     */
    inline bool approximately(const float2x2& a, const float2x2& b, float epsilon = Constants::Constants<float>::Epsilon) noexcept
    {
     ...
     * @return True if matrix is orthogonal
     */
    inline bool is_orthogonal(const float2x2& mat, float epsilon = Constants::Constants<float>::Epsilon) noexcept { return mat.is_orthogonal(epsilon); }
     ...
     * @return True if matrix is pure rotation
     */
    inline bool is_rotation(const float2x2& mat, float epsilon = Constants::Constants<float>::Epsilon) noexcept { return mat.is_rotation(epsilon); }
